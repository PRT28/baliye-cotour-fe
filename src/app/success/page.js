           ...
           <Player
            ...
            <div className={styles.orderList}>
                <div className={styles.card}>
                    ...
                    <div className={styles.cardSub}>Tailored and delivered in 3 weeks</div>
                </div>
            ...
            <div style={{display: 'flex', alignItems: 'center', justifyContent: 'center', width: '100%', gap: '80px', marginTop: '24px', marginBottom: '24px'}}>
